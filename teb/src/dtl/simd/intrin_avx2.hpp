...
struct mask4 {
  ...
  {
    return _mm256_testz_si256(data, ALL_ONES.i) == 0;
  };
  ...
  __forceinline__ void set(u64 idx, u1 value)
  {
    ...
    switch (idx) {
    case 0:
      data = _mm256_insert_epi64(data, v, 0);
      break;
    case 1:
      data = _mm256_insert_epi64(data, v, 1);
      break;
    case 2:
      data = _mm256_insert_epi64(data, v, 2);
      break;
    case 3:
      data = _mm256_insert_epi64(data, v, 3);
      break;
//      default: unreachable();
    }
  };
  ...
  __forceinline__ u1 get(u64 idx) const
  {
    switch (idx) {
    case 0:
      return _mm256_extract_epi64(data, 0) != 0;
    case 1:
      return _mm256_extract_epi64(data, 1) != 0;
    case 2:
      return _mm256_extract_epi64(data, 2) != 0;
    case 3:
      return _mm256_extract_epi64(data, 3) != 0;
//      default: unreachable();
    }
  };
  __forceinline__ mask4 bit_and(const mask4& o) const
  {
    return mask4 { _mm256_and_si256(data, o.data) };
  };
  __forceinline__ mask4 bit_or(const mask4& o) const
  {
    return mask4 { _mm256_or_si256(data, o.data) };
  };
  __forceinline__ mask4 bit_xor(const mask4& o) const
  {
    return mask4 { _mm256_xor_si256(data, o.data) };
  };
  __forceinline__ mask4 bit_not() const
  {
    return mask4 { _mm256_andnot_si256(data, _mm256_set1_epi64x(-1)) };
  };
...
//  __forceinline__ u1 none() const { return _mm256_movemask_epi8(data) == 0; };
  ...
  __forceinline__ void set(u64 idx, u1 value)
  {
    ...
    case 0:
      data = _mm256_insert_epi32(data, v, 0);
      break;
    case 1:
      data = _mm256_insert_epi32(data, v, 1);
      break;
    case 2:
      data = _mm256_insert_epi32(data, v, 2);
      break;
    case 3:
      data = _mm256_insert_epi32(data, v, 3);
      break;
    case 4:
      data = _mm256_insert_epi32(data, v, 4);
      break;
    case 5:
      data = _mm256_insert_epi32(data, v, 5);
      break;
    case 6:
      data = _mm256_insert_epi32(data, v, 6);
      break;
    case 7:
      data = _mm256_insert_epi32(data, v, 7);
      break;
//      default: unreachable();
    }
  };
  ...
  __forceinline__ u1 get(u64 idx) const
  {
    switch (idx) {
    case 0:
      return _mm256_extract_epi32(data, 0) != 0;
    case 1:
      return _mm256_extract_epi32(data, 1) != 0;
    case 2:
      return _mm256_extract_epi32(data, 2) != 0;
    case 3:
      return _mm256_extract_epi32(data, 3) != 0;
    case 4:
      return _mm256_extract_epi32(data, 4) != 0;
    case 5:
      return _mm256_extract_epi32(data, 5) != 0;
    case 6:
      return _mm256_extract_epi32(data, 6) != 0;
    case 7:
      return _mm256_extract_epi32(data, 7) != 0;
//      default: unreachable();
    }
  };
  __forceinline__ mask8 bit_and(const mask8& o) const
  {
    return mask8 { _mm256_and_si256(data, o.data) };
  };
  __forceinline__ mask8 bit_or(const mask8& o) const
  {
    return mask8 { _mm256_or_si256(data, o.data) };
  };
  __forceinline__ mask8 bit_xor(const mask8& o) const
  {
    return mask8 { _mm256_xor_si256(data, o.data) };
  };
  __forceinline__ mask8 bit_not() const
  {
    return mask8 { _mm256_andnot_si256(data, _mm256_set1_epi64x(-1)) };
  };

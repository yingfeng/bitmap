...
//  }
  ...
  auto _get_tree_bit_cnt()
  {
    return structure_.size();
  }
  auto _get_tree_leading_1bit_cnt()
  {
    return implicit_inner_node_cnt_;
  }
  auto _get_tree_trailing_0bit_cnt()
  {
    return implicit_leaf_node_cnt_;
  }
  auto _get_label_bit_cnt()
  {
    return labels_.size();
  }
  auto _get_label_leading_0bit_cnt()
  {
    return implicit_leading_label_cnt_;
  }
  auto _get_label_trailing_0bit_cnt()
  {
    return implicit_trailing_label_cnt_;
  }
  //===--------------------------------------------------------------------===//
...
//    auto pos = path << (h - 1 - path_level);
  ...
  next_batch_swar() noexcept __attribute__((flatten, hot, noinline))
  {
    ...
    auto advance_label_scanner = [&](u32 level) {
      ...
      switch (buffer_idx) {
      case 0:
        l_bb0.increment(slot_mask);
        break;
      case 1:
        l_bb1.increment(slot_mask);
        break;
      case 2:
        l_bb2.increment(slot_mask);
        break;
      case 3:
        l_bb3.increment(slot_mask);
        break;
      }
    };
    ...
    while (result_cnt < batch_size_ - 8) {
      ...
      for ($i32 b = 0; b < 7; ++b) {
        ...
        switch (buffer_idx) {
        case 0:
          label = l_bb0.read(label_mask) != 0;
          break;
        case 1:
          label = l_bb1.read(label_mask) != 0;
          break;
        case 2:
          label = l_bb2.read(label_mask) != 0;
          break;
        case 3:
          label = l_bb3.read(label_mask) != 0;
          break;
        }
        // Produce output (a 1-fill).
        results_[result_cnt].pos = pos;
      ...
      auto get_tree_scanner_read_pos = [&](u32 level) {
        ...
        switch (buffer_idx) {
        case 0:
          ret_val = t_bb0.get_read_pos(slot_idx);
          break;
        case 1:
          ret_val = t_bb1.get_read_pos(slot_idx);
          break;
        case 2:
          ret_val = t_bb2.get_read_pos(slot_idx);
          break;
        case 3:
          ret_val = t_bb3.get_read_pos(slot_idx);
          break;
        }
        return ret_val;
      };
      auto get_label_scanner_read_pos = [&](u32 level) {
        ...
        switch (buffer_idx) {
        case 0:
          ret_val = l_bb0.get_read_pos(slot_idx);
          break;
        case 1:
          ret_val = l_bb1.get_read_pos(slot_idx);
          break;
        case 2:
          ret_val = l_bb2.get_read_pos(slot_idx);
          break;
        case 3:
          ret_val = l_bb3.get_read_pos(slot_idx);
          break;
        }
        return ret_val;
      };
